...
@Component({
  ...
  templateUrl: './typeahead-sample.component.html',
  styleUrls: ['./typeahead-sample.component.scss']
})
export class TypeaheadSampleComponent implements OnInit {

  public saSelected: string;
  public itSelected: string;
